...
class GovernanceReport:
    ...
    def summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "topology_profiles": _payload_int(payloads.get("topology", {}), "profile_count"),
            "topology_warnings": _payload_int(payloads.get("topology", {}), "warning_count"),
            "topology_infos": _payload_int(payloads.get("topology", {}), "info_count"),
...
def _result_warning_count(result: GovernanceCheckResult) -> int:
    ...
    if result.name == "kubernetes-render":
        return _kubernetes_warning_count(_warning_summary(result.payload.get("warning_summary")))
...
def _result_info_count(result: GovernanceCheckResult) -> int:
    if result.payload is None:
        return 0
    if result.name == "kubernetes-render":
        return _warning_summary(result.payload.get("warning_summary"))["info"]
