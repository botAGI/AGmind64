...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    from agmind.services.renderer import load_descriptors, select_services, unknown_profiles
    ...
    for profiles in (*PROFILE_SETS, ("full",)):
        ...
        if missing_profiles:
            ...
            errors.append(f"{profile_key}: unknown profile(s): {', '.join(missing_profiles)}")
            continue
